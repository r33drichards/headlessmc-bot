...
- **`Dockerfile`** — Based on `eclipse-temurin:21-jammy` (multi-arch, ARM64 native). Downloads HeadlessMC wrapper, sets up Xvfb + VNC + noVNC, downloads Meteor Client and Baritone for MC 1.21.1, configures HeadlessMC to use Xvfb instead of LWJGL patching.
